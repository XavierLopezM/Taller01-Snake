...
public class SnakeModel extends GameModel {
	...
	private static final GameTile SNAKE_TILE = new RectangularTile(new Color(128, 7, 0));

	/** Graphical representation of the snake's head */
	private static final GameTile SNAKE_HEAD_TILE = new RectangularTile(new Color(166, 9, 0));
